...
**Code to transform the dataset** : miniproj_transform.py will be there in this file.
...
**Trajectory prediction code** :  Trajectory_prediction.py will be there in this file.
